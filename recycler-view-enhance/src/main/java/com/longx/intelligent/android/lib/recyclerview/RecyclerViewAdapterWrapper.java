...
public class RecyclerViewAdapterWrapper extends BaseRecyclerViewAdapterWrapper {
    ...
    public RecyclerViewAdapterWrapper(@NonNull WrappableRecyclerViewAdapter wrappableRecyclerViewAdapter) {
        super(wrappableRecyclerViewAdapter);
        wrappableRecyclerViewAdapter.setRecyclerViewAdapterWrapper(this);
    }
    ...
    public int getNotifyItemPosition(int position){
