...
class BaseRecyclerViewAdapterWrapper extends RecyclerView.Adapter {

    protected final WrappableRecyclerViewAdapter wrapped;

    public BaseRecyclerViewAdapterWrapper(WrappableRecyclerViewAdapter wrapped) {
        super();
    ...
    public WrappableRecyclerViewAdapter getWrappedAdapter() {
        return wrapped;
    }
}
