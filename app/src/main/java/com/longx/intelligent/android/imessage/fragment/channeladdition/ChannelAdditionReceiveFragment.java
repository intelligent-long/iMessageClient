...
import com.longx.intelligent.android.imessage.adapter.ChannelAdditionActivitiesReceiveRecyclerAdapter;
...
import com.longx.intelligent.android.imessage.databinding.FragmentChannelAdditionReceiveBinding;
    ...
    private void setupRecyclerView(List<ChannelAddition> channelAdditions) {
        ...
        channelAdditions.forEach(channelAdditionInfo -> {
            if ((channelAdditionInfo.getRespondTime() != null || channelAdditionInfo.isExpired())
                    && channelAdditionInfo.getResponderChannel().getImessageId().equals(currentUserInfo.getImessageId()))
