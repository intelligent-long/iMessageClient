...
public class GroupMembersRecyclerAdapter extends WrappableRecyclerViewAdapter<GroupMembersRecyclerAdapter.ViewHolder, GroupMembersRecyclerAdapter.ItemData> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        private final RecyclerItemGroupMembersBinding binding;
        public ViewHolder(RecyclerItemGroupMembersBinding binding) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RecyclerItemGroupMembersBinding binding = RecyclerItemGroupMembersBinding.inflate(activity.getLayoutInflater());
