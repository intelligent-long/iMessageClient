 ...
 */
public class SettingTagNewGroupChannelTagsRecyclerAdapter extends WrappableRecyclerViewAdapter<SettingTagNewGroupChannelTagsRecyclerAdapter.ViewHolder, List<ChannelTag>> {
    ...
    public SettingTagNewGroupChannelTagsRecyclerAdapter(AppCompatActivity activity) {
