    ...
    private void setupYiers() {
        binding.toolbar.setOnMenuItemClickListener(item -> {
            if (item.getItemId() == R.id.change) {
                ...
                ChangeGroupNamePostBody postBody = new ChangeGroupNamePostBody(groupChannel.getGroupChannelId(), inputtedGroupName);
                GroupChannelApiCaller.changeGroupName(this, postBody, new RetrofitApiCaller.CommonYier<OperationStatus>(this) {
                    ...
                    public void ok(OperationStatus data, Response<OperationStatus> raw, Call<OperationStatus> call) {
                        ...
                        data.commonHandleResult(ChangeGroupNameActivity.this, new int[]{-101, -102}, () -> {
