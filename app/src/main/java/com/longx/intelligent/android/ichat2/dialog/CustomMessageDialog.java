...
public class CustomMessageDialog extends AbstractDialog{
    ...
    public CustomMessageDialog(AppCompatActivity activity, String message) {
        this(activity, null, null, message);
    }

    public CustomMessageDialog(AppCompatActivity activity, Integer iconId, String message) {
        this(activity, iconId, null, message);
    }

    public CustomMessageDialog(AppCompatActivity activity, String title, String message) {
        this(activity, null, title, message);
    }

    public CustomMessageDialog(AppCompatActivity activity, Integer iconId, String title, String message) {
        super(activity, true);
        this.iconId = iconId;
        this.title = title;
